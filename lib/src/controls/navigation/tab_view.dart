...
class _TabViewState extends State<TabView> {
  ...
  void didUpdateWidget(TabView oldWidget) {
    ...
    if (widget.currentIndex != oldWidget.currentIndex && scrollController.hasClients) {
  ...
  void close(int index) {
    ...
    if (closable) {
      ...
      final tabBox = tab._tabKey.currentContext?.findRenderObject() as RenderBox?;
  ...
  Widget _tabBuilder(
    ...
    final tabWidget = TabData(
      ...
      onPressed: widget.onChanged == null ? null : () => widget.onChanged!(index),
    ...
    final Widget child = GestureDetector(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        Flexible(
          fit: widget.tabWidthBehavior == TabWidthBehavior.equal ? FlexFit.tight : FlexFit.loose,
          child: tabWidget,
        ),
        divider(index),
      ]),
        ...
        style: ButtonStyle(
          foregroundColor: WidgetStateProperty.resolveWith((states) {
            if (states.isDisabled) {
              return FluentTheme.of(context).resources.accentTextFillColorDisabled;
            } else {
    ...
    return SizedBox(
      ...
      child: Divider(
        ...
        style: DividerThemeData(
          ...
          decoration: ![widget.currentIndex - 1, widget.currentIndex].contains(index)
              ? null
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.shortcutsEnabled) {
      ...
      var ctrl = true;
      var meta = false;
      if (!kIsWeb && [TargetPlatform.iOS, TargetPlatform.macOS].contains(defaultTargetPlatform)) {
        ctrl = false;
        meta = true;
      }
...
class TabState extends State<Tab> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final text = () {
      if (widget.text is Text) {
        return (widget.text as Text).data ?? (widget.text as Text).textSpan?.toPlainText();
        ...
        Widget child = FocusBorder(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: (tab.selected ? widget.selectedBackgroundColor : widget.backgroundColor) ?? backgroundColor,
            ),
            child: () {
                  ...
                  child: IconTheme.merge(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      if (tab.tabWidthBehavior != TabWidthBehavior.compact ||
                          (tab.tabWidthBehavior == TabWidthBehavior.compact && tab.selected))
                        Flexible(
                          fit: tab.tabWidthBehavior == TabWidthBehavior.equal ? FlexFit.tight : FlexFit.loose,
                          child: Padding(
